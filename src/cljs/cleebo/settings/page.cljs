(ns cleebo.settings.page
  (:require [reagent.core :as reagent]
            ...
            [cleebo.settings.components.query-settings :refer [query-settings]]
            [cleebo.settings.components.notification-settings :refer [notification-settings]]
            [cleebo.settings.components.appearance-settings :refer [appearance-settings]]
