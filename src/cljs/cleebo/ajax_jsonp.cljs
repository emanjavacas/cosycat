...
;;; shamelessly borrowed from https://github.com/cemerick/url/blob/master/src/cemerick/url.cljx
(defn url-encode
  [string]
...
(defn jsonp
  ...
  (let [the-jsonp (goog.net.Jsonp. (Uri. (build-uri uri params) json-callback-str))]
